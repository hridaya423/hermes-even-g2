...
@Serializable data class RuntimeReadiness(val bridge: Boolean = false, val hermes: Boolean = false, val coreReady: Boolean = false, val guiReady: Boolean = false, val tailscale: Boolean = false, val stt: Boolean = false, val reason: String? = null)
