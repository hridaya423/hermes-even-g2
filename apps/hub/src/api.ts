import type { AgentAction, DurableEvent, HermesCapabilities, RuntimeReadiness, SessionSummary } from "@hermes-g2/protocol";

export type Credentials = {origin: string; deviceId: string; credential: string};
export type Snapshot = {sessions: SessionSummary[] | {items?: SessionSummary[]}; cursor: number; runtime: RuntimeReadiness; hermes: HermesCapabilities};
